...
def scale_data(data):
    ...
    data_scaled = (X_train - mean_on_train) / std_on_train
    # X_test_scaled = (X_test - mean_on_train) / std_on_train
    # print("X train scaled:", data_scaled.shape)
...
def predict_upcoming_fights():
    ...
    scaled_predictable_data = scale_data(predictable_data)
    # print("scaled predictable data", scaled_predictable_data)
    loaded_model = pickle.load(open('./models/trained/mlps-2023-12-16.sav', 'rb'))
    results = loaded_model.predict(scaled_predictable_data)
    confidence_levels = loaded_model.predict_proba(scaled_predictable_data)
    # print(results)
